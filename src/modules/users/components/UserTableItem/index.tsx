import { Box, Avatar, Typography, Button, Chip, BoxProps } from "@mui/material";
                ...
                <Chip
                    ...
                    label={
                        user.is_assigned_to_chat
                            ? t("users.is_assigned_to_chat")
                            : t("users.is_not_assigned_to_chat")
                    }
                />
                <Chip
                    color={
                        user.user_role === Roles.USER ? "secondary" : "error"
                    }
                    sx={{
                        color: theme.palette.text.primary,
                    }}
