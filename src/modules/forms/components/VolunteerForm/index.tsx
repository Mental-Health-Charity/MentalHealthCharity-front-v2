...
const VolunteerForm = ({ onSubmit }: Props) => {
                    ...
                    >
                        ...
                        >
                            <MenuItem value="elementary">
                                {t("form.volunteer.education.elementary")}
                            </MenuItem>
                            <MenuItem value="high_school">
                                {t("form.volunteer.education.high_school")}
                            </MenuItem>
                            <MenuItem value="bachelor">
                                {t("form.volunteer.education.bachelor")}
                            </MenuItem>
                            <MenuItem value="master">
                                {t("form.volunteer.education.master")}
                            </MenuItem>
                            <MenuItem value="phd">
                                {t("form.volunteer.education.phd")}
                            </MenuItem>
                        </TextField>
                    </Box>
                )}
                    ...
                    >
                        ...
                        <TextField
                            ...
                            error={
                                ...
                                Boolean(formik.errors.did_help)
                            }
                            helperText={
                                formik.touched.did_help &&
                        ...
                        >
                            <MenuItem value="yes_professional">
                                {t(
                                    "form.volunteer.prior_experience.yes_professional"
                                )}
                            </MenuItem>
                            <MenuItem value="yes_personal">
                                {t(
                                    "form.volunteer.prior_experience.yes_personal"
                                )}
                            </MenuItem>
                            <MenuItem value="no">
                                {t("form.volunteer.prior_experience.no")}
                            </MenuItem>
                        </TextField>
                    </Box>
                )}
                ...
                {step === 5 && (
                    ...
                    >
                        <FormControl>
                            ...
                            <Select
                                label={t(
                                    "form.volunteer.issues_to_avoid_label"
                                )}
                                name="themes"
